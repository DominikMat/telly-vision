...
let lastHooveringStep = 0;
let isHoovering = false;
let hooveringStartTime = 0;
let hooveringStepsDone = 0;
let tellyVisibleInStepCount = 0;
let hooverScore = 0;
let hooverProgress = 0;
...
function drawHooveringProgress(ctx) {
    if (!ctx)
        return;
